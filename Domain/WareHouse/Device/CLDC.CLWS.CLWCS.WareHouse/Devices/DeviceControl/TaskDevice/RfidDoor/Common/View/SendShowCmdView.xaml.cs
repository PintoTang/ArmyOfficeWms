...
{
    /// <summary>
    /// SendShowCmdView.xaml 的交互逻辑
    /// </summary>
    public partial class SendShowCmdView : UserControl
    {
        public SendShowCmdView(SendShowCmd dataModel)
        {
            InitializeComponent();
            this.DataContext=new SendShowCmdViewModel(dataModel);
        }
    }
}
