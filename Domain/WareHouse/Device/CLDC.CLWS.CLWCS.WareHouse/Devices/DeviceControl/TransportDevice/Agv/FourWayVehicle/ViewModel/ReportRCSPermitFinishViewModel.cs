...
{
   public class ReportRCSPermitFinishViewModel : ViewModelBase, IInvokeCmd
    {
        public ReportRCSPermitFinishCmd DataModel { get; set; }

        public ReportRCSPermitFinishViewModel(ReportRCSPermitFinishCmd dataModel)
        {
            DataModel = dataModel;
        }
