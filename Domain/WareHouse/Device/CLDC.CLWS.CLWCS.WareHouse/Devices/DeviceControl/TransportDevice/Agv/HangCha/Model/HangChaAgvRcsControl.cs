...
{
    public class HangChaAgvRcsControl : OrderDeviceControlAbstract
    {
        ...
        public override OperateResult DoJob(TransportMessage transMsg)
        {
            ...
            try
            {
                ...
                WebApiInvokeCmd apiCmd = new WebApiInvokeCmd(Http, HangChaAgvRcsApiEnum.SendTask.ToString(),
               cmd.ToJson());
        ...
        {
            WebApiInvokeCmd apiCmd = new WebApiInvokeCmd(Http, HangChaAgvRcsApiEnum.SendNextAddrPermit.ToString(),
                cmd.ToJson());
            return SendCmd(apiCmd);
        }
        ...
        {
            WebApiInvokeCmd apiCmd = new WebApiInvokeCmd(Http, HangChaAgvRcsApiEnum.SendDeviceAction.ToString(),cmd.ToJson());
            return SendCmd(apiCmd);
        }
