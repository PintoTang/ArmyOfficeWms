...
{
    public class YingChuangAgvRcsControl : OrderDeviceControlAbstract
    {
        ...
        public override OperateResult DoJob(TransportMessage transMsg)
        {
            ...
            try
            {
                ...
                {
                    ADDR_REQUEST = RequestTypeEnum.UnRequest,
                    ...
                    TASK_NO = transMsg.TransportOrder.DeviceTaskNo,
                    TASK_TYPE = (int)transMsg.TransportOrder.SourceTaskType
                };
                GoodsProperty property = new GoodsProperty() {BoxCount=transMsg.TransportOrder.GoodsCount,BoxType=transMsg.TransportOrder.GoodsType};
                cmd.EXT1 = property.ToJson();
                WebApiInvokeCmd apiCmd = new WebApiInvokeCmd(Http, YingChuangAgvRcsApiEnum.SendTask.ToString(),
               cmd.ToJson());
        ...
        public OperateResult SendNextAddrPermit(SendNextAddrPermitCmd cmd)
        {
            WebApiInvokeCmd apiCmd = new WebApiInvokeCmd(Http, YingChuangAgvRcsApiEnum.SendNextAddrPermit.ToString(),
                cmd.ToJson());
            return SendCmd(apiCmd);
        }
        ...
        {
            WebApiInvokeCmd apiCmd = new WebApiInvokeCmd(Http, YingChuangAgvRcsApiEnum.SendDeviceAction.ToString(),
    cmd.ToJson());
            return SendCmd(apiCmd);
        }
