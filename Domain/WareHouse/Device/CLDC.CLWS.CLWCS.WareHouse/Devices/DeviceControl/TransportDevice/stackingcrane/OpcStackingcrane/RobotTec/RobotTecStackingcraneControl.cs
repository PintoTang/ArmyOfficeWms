...
namespace CLDC.CLWS.CLWCS.WareHouse.Device
{
    ...
    /// 罗伯泰克堆垛机控制
    /// </summary>
    public sealed class RobotTecStackingcraneControl : OrderDeviceControlAbstract
    {
        ...
        {
            OperateResult write = Communicate.Write(DataBlockNameEnum.DeviceConnectStatus, 0);
            if (write.IsSuccess)
            {
                return true;
            }
