...
namespace CLDC.CLWS.CLWCS.WareHouse.Device.Devices.Device.Common.ViewModel
{
    ...
    /// 设备配置的ViewModel
    /// </summary>
    public class DeviceConfigViewModel<TDevice, TConfig> : ViewModelBase
        where TDevice : DeviceBaseAbstract
        where TConfig : ICreateMenuItem
    {

        public DeviceConfigViewModel(TDevice deviceViewModel, TConfig curConfig)
        {
        ...
        private void SaveConfig()
        {
            try
            {
                ...
                if (rt.Equals(MessageBoxResult.Yes))
                {
                    ...
                    XmlNode xmlNode = doc.GetXmlNode("Device", "DeviceId", Device.Id.ToString());
                    ...
                    string projectPath = projectPathResult.Content + "\\DeviceConfig.xml";
                    ...
                    //OperateResult deviceUpateResult = Device.UpdateProperty();
