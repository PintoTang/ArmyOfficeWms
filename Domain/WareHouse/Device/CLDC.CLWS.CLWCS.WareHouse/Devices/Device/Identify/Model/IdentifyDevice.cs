...
namespace CLDC.CLWS.CLWCS.WareHouse.Device
{
    ...
    /// OPC控制条码枪虚类
    /// </summary>
    public class IdentifyDevice : IdentityDeviceAbstract<List<string>>
    {
        ...
        public override OperateResult<WareHouseViewModelBase> CreateViewModel()
        {
            ...
            IdentityDeviceViewModel viewModel = new IdentityDeviceViewModel(this);
        ...
        protected override Window CreateConfigView()
        {
            ...
            DeviceConfigViewModel<IdentifyDevice, IdentityDeviceProperty> viewModel = new DeviceConfigViewModel<IdentifyDevice, IdentityDeviceProperty>(this, DeviceProperty);
