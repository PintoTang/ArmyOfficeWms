...
using CLDC.CLWS.CLWCS.WareHouse.Device.Devices.Device.Identify.ViewModel;
...
namespace CLDC.CLWS.CLWCS.WareHouse.Device
{
    ...
    /// socket控制条码枪虚类
    /// </summary>
    public class IdentifyDeviceForSocket : IdentityDeviceAbstract<List<string>>
    {
        private IdentityDeviceProperty _deviceProperty = new IdentityDeviceProperty();

        public IdentityDeviceProperty DeviceProperty
        {
            get
            {
        ...
        public override OperateResult ParticularConfig()
        {
            ...
            try
            {
                ...
                using (StringReader sr = new StringReader(stationPropertyXml))
                {
                    try
                    {
                        DeviceProperty = (IdentityDeviceProperty)XmlSerializerHelper.DeserializeFromTextReader(sr, typeof(IdentityDeviceProperty));
        ...
        public override OperateResult<WareHouseViewModelBase> CreateViewModel()
        {
            ...
            IdentityDeviceForSocketViewModel viewModel = new IdentityDeviceForSocketViewModel(this);
        ...
        {
            UserControl view = new IdentifyDeviceDetailView();
        ...
        protected override Window CreateConfigView()
        {
            ...
            DeviceConfigViewModel<IdentifyDeviceForSocket, IdentityDeviceProperty> viewModel = new DeviceConfigViewModel<IdentifyDeviceForSocket, IdentityDeviceProperty>(this, DeviceProperty);
