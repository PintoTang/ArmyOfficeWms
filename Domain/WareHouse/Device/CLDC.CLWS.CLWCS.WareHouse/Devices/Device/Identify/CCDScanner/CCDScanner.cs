...
using CLDC.CLWS.CLWCS.WareHouse.Device.Devices.Device.Identify.KeyenceScanner;
...
namespace CLDC.CLWS.CLWCS.WareHouse.Device
{
    ...
    /// CCD
    /// </summary>
    public class CCDScanner : IdentityDeviceAbstract<List<string>>
    {
        private KeyenceRfidDeviceProperty _deviceProperty = new KeyenceRfidDeviceProperty();

        public KeyenceRfidDeviceProperty DeviceProperty
        {
            get
            {
        ...
        public override OperateResult ParticularConfig()
        {
            ...
            try
            {
                ...
                using (StringReader sr = new StringReader(stationPropertyXml))
                {
                    try
                    {
                        DeviceProperty = (KeyenceRfidDeviceProperty)XmlSerializerHelper.DeserializeFromTextReader(sr, typeof(KeyenceRfidDeviceProperty));
        ...
        public override OperateResult<WareHouseViewModelBase> CreateViewModel()
        {
            ...
            CCDScannerViewModel viewModel = new CCDScannerViewModel(this);
        ...
        {
            return new KeyenceScannerAssistantView();
        }

        protected override OperateResult<UserControl> CreateDetailView()
        {
            UserControl view = new KeyenceScannerDetailView();
        ...
        protected override Window CreateConfigView()
        {
            ...
            DeviceConfigViewModel<CCDScanner, KeyenceRfidDeviceProperty> viewModel = new DeviceConfigViewModel<CCDScanner, KeyenceRfidDeviceProperty>(this, DeviceProperty);
        ...
        {
            if (SystemConfig.Instance.WhCode.Equals("FS1") || SystemConfig.Instance.WhCode.Equals("SCNT1"))
            {
                return false;
            }
            else
