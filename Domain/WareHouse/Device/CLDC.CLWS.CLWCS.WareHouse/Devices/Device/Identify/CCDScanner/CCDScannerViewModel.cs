...
{
    public class CCDScannerViewModel : DeviceViewModelAbstract<WareHouse.Device.CCDScanner>
    {
        public CCDScannerViewModel(WareHouse.Device.CCDScanner device)
            : base(device)
        {
            _controlCommunicate = (CCDScannerHK1628M12MP)device.DeviceControl.Communicate;
            InitSocketViewModel();
        }
        ...
        private readonly CCDScannerHK1628M12MP _controlCommunicate;
