...
{
    public class RobotViewModel : DeviceViewModelAbstract<WareHouse.Device.Robot>
    {
        public RobotViewModel(WareHouse.Device.Robot device) : base(device)
        {
            _controlCommunicate = (RobotFuSha)device.DeviceControl.Communicate;
            InitSocketViewModel();
        }
        ...
        private readonly RobotFuSha _controlCommunicate;
