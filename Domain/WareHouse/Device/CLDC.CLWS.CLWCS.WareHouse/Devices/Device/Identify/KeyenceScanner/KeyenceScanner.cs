...
namespace CLDC.CLWS.CLWCS.WareHouse.Device
{
    ...
    /// 基恩士条码枪 SR 2000
    /// </summary>
    public class KeyenceScanner : IdentityDeviceAbstract<List<string>>
    {
        ...
        public override OperateResult<WareHouseViewModelBase> CreateViewModel()
        {
            ...
            KeyenceScannerViewModel viewModel = new KeyenceScannerViewModel(this);
        ...
        protected override Window CreateConfigView()
        {
            ...
            DeviceConfigViewModel<KeyenceScanner, KeyenceRfidDeviceProperty> viewModel = new DeviceConfigViewModel<KeyenceScanner, KeyenceRfidDeviceProperty>(this, DeviceProperty);
