...
using CLDC.CLWS.CLWCS.WareHouse.Device.Devices.Device.TaskDevice.RfidDoor.YChuangRfidDoor.View;
using CLDC.CLWS.CLWCS.WareHouse.Device.Devices.Device.TaskDevice.RfidDoor.YChuangRfidDoor.ViewModel;
...
{
    public sealed class YChuangRfidDoorDevice : StackRfidDeviceAbstract, ISwitch, IShowScreen
    {
        private YChuangRfidDoorDeviceProperty _deviceProperty = new YChuangRfidDoorDeviceProperty();

        public YChuangRfidDoorDeviceProperty DeviceProperty
        {
            get
            {
        ...
        public override OperateResult ParticularConfig()
        {
            ...
            try
            {
                ...
                using (StringReader sr = new StringReader(stationPropertyXml))
                {
                    try
                    {
                        DeviceProperty = (YChuangRfidDoorDeviceProperty)XmlSerializerHelper.DeserializeFromTextReader(sr, typeof(YChuangRfidDoorDeviceProperty));
        ...
        public override OperateResult<WareHouseViewModelBase> CreateViewModel()
        {
            ...
            YChuangRfidDoorViewModel viewModel = new YChuangRfidDoorViewModel(this);
        ...
        {
            YChuangRfidDoorAssistantView assistantView = new YChuangRfidDoorAssistantView();
        ...
        protected override Window CreateConfigView()
        {
            ...
            DeviceConfigViewModel<YChuangRfidDoorDevice, YChuangRfidDoorDeviceProperty> viewModel = new DeviceConfigViewModel<YChuangRfidDoorDevice, YChuangRfidDoorDeviceProperty>(this, DeviceProperty);
        ...
        {
            UserControl view = new YChuangRfidDoorDetailView();
        ...
        public override OperateResult CloseDoor(string cmd)
        {
            ...
            {
                return OperateResult.CreateFailedResult(sendResult.Message);
            }
        ...
        public override OperateResult Stack(string taskNo, string stackCode, int pileNo, int stackNo, int boxType)
        {
            ...
            {
                return OperateResult.CreateFailedResult(sendToDeviceResult.Message);
            }
            SyncResReMsg responseResult = (SyncResReMsg)sendToDeviceResult.Content;
            if (!responseResult.IsSuccess)
            {
                return OperateResult.CreateFailedResult(sendToDeviceResult.Content);
            }
        ...
        public override OperateResult UnStack(string taskNo, string stackCode, int pileNo, int unStackNo, int boxType)
        {
            ...
            SendStackTaskCmd stackTask = new SendStackTaskCmd();
            stackTask.BOX_COUNT = pileNo;
            stackTask.BOX_TYPE = (BoxTypeEnum)boxType;
            stackTask.DEVICE_NO = this.ExposedUnId;
