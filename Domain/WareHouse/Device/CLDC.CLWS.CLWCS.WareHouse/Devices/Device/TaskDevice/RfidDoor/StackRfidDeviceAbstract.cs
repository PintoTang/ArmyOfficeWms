...
{
    public abstract class StackRfidDeviceAbstract : DeviceBaseForTask<StringCharTask>, IDoorDevice, IScanDevice, IStackDevice, ITaskDevice<StringCharTask>
    {
        /// <summary>
        /// 下发命令
        /// </summary>
        ...
        public abstract OperateResult Stack(string taskNo, string stackCode, int pileNo, int stackNo, int boxType);

        public abstract OperateResult UnStack(string taskNo, string stackCode, int pileNo, int unStackNo, int boxType);
