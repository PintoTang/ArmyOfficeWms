...
{
    public class DeviceParamsPalletizerViewModel : DeviceDataBase
    {
        #region 属性
        ...
        private PalletizerDeviceViewModel DeviceViewModel { get; set; }
        /// <summary>
        /// 上一个对象 传递过来的 DataContext
        /// </summary>
        /// <param name="PreDataContext"></param>
        public DeviceParamsPalletizerViewModel(object PreDataContext)
        {
            DeviceViewModel = PreDataContext as PalletizerDeviceViewModel;
            XmlNodeName = "PalletizerDevices";
        ...
        public void ReadOpc(DataBlockNameEnum dblockNameEm)
        {
            var curObj = Datablocks.Where(x => x.DatablockEnum.Equals(dblockNameEm)).FirstOrDefault();
            OperateResult<string> opResult = IPlcDeviceCom.ReadString(dblockNameEm);
            curObj.RealValue = opResult == null ? "" : opResult.Content;
        }
        ...
        public OperateResult Save(object vmObj)
        {
            ...
            {
                //更新缓存
                //LoadDeviceViewModel deviceViewModel = vmObj as LoadDeviceViewModel;
