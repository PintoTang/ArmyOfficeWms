...
using CLDC.CLWS.CLWCS.WareHouse.Device.Devices.Device.TransportDevice.Agv.MNLMCha.View;
using CLDC.CLWS.CLWCS.WareHouse.Device.Devices.Device.TransportDevice.Agv.MNLMCha.ViewModel;
...
namespace CLDC.CLWS.CLWCS.WareHouse.Device
{
    ...
    /// 木牛流马 AGV
    /// </summary>
    public class MNLMChaAgv : AgvDeviceAbstract
    {
        ...
        public override OperateResult<WareHouseViewModelBase> CreateViewModel()
        {
            ...
            MNLMChaAGVViewModel viewModel = new MNLMChaAGVViewModel(this);
        ...
        {
            UCMNLMChaAGVView assistantView = new UCMNLMChaAGVView();
        ...
        protected override OperateResult<UserControl> CreateDetailView()
        {
            ...
            MNLMChaAgvDetailView view = new MNLMChaAgvDetailView();
            result.IsSuccess = true;
            result.Content = view;
            return result;
        }
