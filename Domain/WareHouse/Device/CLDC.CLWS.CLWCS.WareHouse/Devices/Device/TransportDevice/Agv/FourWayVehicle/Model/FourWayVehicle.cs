...
namespace CLDC.CLWS.CLWCS.WareHouse.Device
{
    ...
    /// 四向车
    /// </summary>
    public class FourWayVehicle : AgvDeviceAbstract
    {
        ...
        private FourWayVehicleProperty _deviceProperty = new FourWayVehicleProperty();

        public FourWayVehicleProperty DeviceProperty
        {
        ...
        public override OperateResult ParticularConfig()
        {
            ...
            try
            {
                ...
                using (StringReader sr = new StringReader(devicePropertyXml))
                {
                    try
                    {
                        DeviceProperty = (FourWayVehicleProperty)XmlSerializerHelper.DeserializeFromTextReader(sr, typeof(FourWayVehicleProperty));
        ...
        public override OperateResult<WareHouseViewModelBase> CreateViewModel()
        {
            ...
            FourWayVehicleViewModel viewModel = new FourWayVehicleViewModel(this);
        ...
        protected override Window CreateConfigView()
        {
            ...
            DeviceConfigViewModel<FourWayVehicle, FourWayVehicleProperty> viewModel = new DeviceConfigViewModel<FourWayVehicle, FourWayVehicleProperty>(this, DeviceProperty);
        ...
        {
            FourWayVehicleAssistantView assistantView = new FourWayVehicleAssistantView();
        ...
        protected override OperateResult<UserControl> CreateDetailView()
        {
            ...
            FourWayVehicleDetailView view = new FourWayVehicleDetailView();
            result.IsSuccess = true;
            result.Content = view;
            return result;
        }
