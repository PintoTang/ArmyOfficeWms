...
namespace CLDC.CLWS.CLWCS.WareHouse.Device
{
    ...
    /// 辊筒线搬运设备
    /// </summary>
    public class ClRoller : TransportDeviceBaseAbstract
    {
        ...
        public override OperateResult DoTransportJob(TransportMessage transport)
        {
            ...
            if (transport.DestDevice!=null)
            {
                if (transport.DestDevice is StationDeviceAbstract)
                {
                    (transport.DestDevice as StationDeviceAbstract).AddUnfinishedTask(transport);
                }
            }
        ...
        public override OperateResult ParticularInitlize(DeviceBusinessBaseAbstract business, DeviceControlBaseAbstract control)
        {
            ...
            OperateResult registerResult = RegisterOrderFinish();
        ...
        private OperateResult RegisterOrderFinish()
        {
          return  this.DeviceControl.RegisterValueChange(DataBlockNameEnum.OPCOrderIdDataBlock, HandleOrderValueChange);
        }
        ...
        protected override Window CreateConfigView()
        {
            ...
            DeviceConfigViewModel<ClRoller, RollerProperty> viewModel = new DeviceConfigViewModel<ClRoller, RollerProperty>(this, DeviceProperty);
