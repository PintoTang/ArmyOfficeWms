...
namespace CLDC.CLWS.CLWCS.WareHouse.Device.Devices.Device.TransportDevice.Simulate3D.ViewModel
{
    public class Simulate3DViewModel : TransportDeviceViewModel
    {
        private readonly Simulate3DControl _deviceControl;
        private readonly IWebNetInvoke _webNetInvoke;
        public Simulate3DViewModel(TransportDeviceBaseAbstract device)
            : base(device)
        {
            Device = device;
            _deviceControl = (Simulate3DControl)Device.DeviceControl;
