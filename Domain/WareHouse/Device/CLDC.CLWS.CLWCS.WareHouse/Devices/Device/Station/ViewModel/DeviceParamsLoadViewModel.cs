...
{
    public class DeviceParamsLoadViewModel : DeviceDataBase
    {
        #region 属性
        private string _deviceModeType;
        public string DeviceModeType
        {
            get { return _deviceModeType; }
            set
            {
                _deviceModeType = value;
        ...
        private StationDeviceViewModel DeviceViewModel { get; set; }
        /// <summary>
        /// 上一个对象 传递过来的 DataContext
        /// </summary>
        /// <param name="PreDataContext"></param>
        public DeviceParamsLoadViewModel(object PreDataContext)
        {
            DeviceViewModel = PreDataContext as StationDeviceViewModel;
            XmlNodeName = "LoadDevices";
        ...
        public OperateResult Save(object vmObj)
        {
            ...
            {
                //更新缓存
                StationDeviceViewModel deviceViewModel = vmObj as StationDeviceViewModel;
