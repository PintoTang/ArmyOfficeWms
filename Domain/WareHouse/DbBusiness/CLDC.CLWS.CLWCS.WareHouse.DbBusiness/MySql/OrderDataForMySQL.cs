...
{
	public class OrderDataForMySQL : OrderDataAbstract
	{
		public OrderDataForMySQL(IDbHelper DbHelper)
		{
		...
		public override List<ExOrder> GetUnfinishedOrders()
		{
			...
			List<ExOrder> orderList = ChangeToExOrder(DbHelper.GetDataSet(sqlstr));
