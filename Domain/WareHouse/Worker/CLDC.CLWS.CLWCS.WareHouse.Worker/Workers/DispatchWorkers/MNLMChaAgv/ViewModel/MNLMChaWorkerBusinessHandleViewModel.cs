...
{
    public class MNLMChaWorkerBusinessHandleViewModel
    {
        public MNLMChaWorkerBusinessHandleProperty DataModel { get; set; }
        public MNLMChaWorkerBusinessHandleViewModel(MNLMChaWorkerBusinessHandleProperty model)
        {
            DataModel = model;
            InitDeviceCodeLst();
        }
        ...
        private void InitDeviceCodeLst()
        {
            ...
            string tempValue = DataModel.Config.AssistantNoConvert.Trim();
        ...
        private void SaveDeviceCode(object arg)
        {
            ...
            DataModel.Config.AssistantNoConvert = DeviceCodeKeyValue.ToString();
