...
namespace CLDC.CLWS.CLWCS.WareHouse.Worker.Workers.DispatchWorkers.HangChaAgv.ViewModel
{
    ...
    public class DeviceParamsDispatchWorkViewModel:WareHouseViewModelBase
    {
        ...
        public DeviceParamsDispatchWorkViewModel(object obj)
        {
            ...
            HangChaWorkerViewModel hangChaWorkerViewModel = viewModelBase as HangChaWorkerViewModel;
        ...
        private void EditOrderData(object obj)
        {
            try
            {
                ...
                //UCHangChaAGVView ucHangChaAGVView = new UCHangChaAGVView();
                //ucHangChaAGVView.DataContext = new HangChaAGVViewModel( obj);
                //ucHangChaAGVView.ShowDialog();
