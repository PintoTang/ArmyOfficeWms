...
{
    public class HangChaWorkerBusinessHandleViewModel
    {
        public HangChaWorkerBusinessHandleProperty DataModel { get; set; }
        public HangChaWorkerBusinessHandleViewModel(HangChaWorkerBusinessHandleProperty model)
        {
            DataModel = model;
            InitDeviceCodeLst();
