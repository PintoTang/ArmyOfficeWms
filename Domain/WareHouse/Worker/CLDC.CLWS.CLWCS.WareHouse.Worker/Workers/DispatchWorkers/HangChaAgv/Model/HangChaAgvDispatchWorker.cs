...
using CLDC.CLWS.CLWCS.WareHouse.Worker.Workers.DispatchWorkers.HangChaAgv.ViewModel;
...
namespace CLDC.CLWS.CLWCS.WareHouse.Worker
{
    ...
    /// 杭叉AGV调度的工作逻辑
    /// </summary>
    public class HangChaAgvDispatchWorker : DispatchWorkerAbstract<HangChaWorkerBusiness>
    {

        private HangChaDispatchWorkerProperty _workerProperty = new HangChaDispatchWorkerProperty();

        public new HangChaDispatchWorkerProperty WorkerProperty
        {
        ...
        protected override OperateResult ParticularConfig()
        {
            ...
            try
            {
                ...
                using (StringReader sr = new StringReader(workerConfigXml))
                {
                    try
                    {
                        WorkerProperty = (HangChaDispatchWorkerProperty)XmlSerializerHelper.DeserializeFromTextReader(sr, typeof(HangChaDispatchWorkerProperty));
        ...
        protected override OperateResult<WareHouseViewModelBase> CreateViewModel()
        {
            ...
            HangChaWorkerViewModel viewModel = new HangChaWorkerViewModel(this);
        ...
        protected override Window CreateConfigView()
        {
            ...
            WorkerConfigViewModel<HangChaAgvDispatchWorker, HangChaDispatchWorkerProperty> viewModel = new WorkerConfigViewModel<HangChaAgvDispatchWorker, HangChaDispatchWorkerProperty>(this, WorkerProperty);
