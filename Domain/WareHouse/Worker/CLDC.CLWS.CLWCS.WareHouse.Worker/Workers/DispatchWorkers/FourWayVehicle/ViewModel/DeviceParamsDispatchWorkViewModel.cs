...
namespace CLDC.CLWS.CLWCS.WareHouse.Worker.Workers.DispatchWorkers.FourWayVehicle.ViewModel
{
    ...
    public class DeviceParamsDispatchWorkViewModel:WareHouseViewModelBase
    {
        ...
        public DeviceParamsDispatchWorkViewModel(object obj)
        {
            ...
            FourWayVehicleWorkerViewModel FourWayVehicleWorkerViewModel = viewModelBase as FourWayVehicleWorkerViewModel;
        ...
        private void EditOrderData(object obj)
        {
            try
            {
                ...
                //UCFourWayVehicleAGVView ucFourWayVehicleAGVView = new UCFourWayVehicleAGVView();
                //ucFourWayVehicleAGVView.DataContext = new FourWayVehicleAGVViewModel( obj);
                //ucFourWayVehicleAGVView.ShowDialog();
