...
using CLDC.CLWS.CLWCS.WareHouse.Worker.Workers.DispatchWorkers.FourWayVehicle.ViewModel;
...
namespace CLDC.CLWS.CLWCS.WareHouse.Worker
{
    ...
    /// 四向车调度的工作逻辑
    /// </summary>
    public class FourWayVehicleDispatchWorker : DispatchWorkerAbstract<FourWayVehicleWorkerBusiness>
    {

        private FourWayVehicleDispatchWorkerProperty _workerProperty = new FourWayVehicleDispatchWorkerProperty();

        public new FourWayVehicleDispatchWorkerProperty WorkerProperty
        {
        ...
        protected override OperateResult ParticularConfig()
        {
            ...
            try
            {
                ...
                using (StringReader sr = new StringReader(workerConfigXml))
                {
                    try
                    {
                        WorkerProperty = (FourWayVehicleDispatchWorkerProperty)XmlSerializerHelper.DeserializeFromTextReader(sr, typeof(FourWayVehicleDispatchWorkerProperty));
        ...
        public override OperateResult RegisterOrderStatusListener()
        {
        ...
        protected override OperateResult<WareHouseViewModelBase> CreateViewModel()
        {
            ...
            FourWayVehicleWorkerViewModel viewModel = new FourWayVehicleWorkerViewModel(this);
        ...
        protected override Window CreateConfigView()
        {
            ...
            WorkerConfigViewModel<FourWayVehicleDispatchWorker, FourWayVehicleDispatchWorkerProperty> viewModel = new WorkerConfigViewModel<FourWayVehicleDispatchWorker, FourWayVehicleDispatchWorkerProperty>(this, WorkerProperty);
