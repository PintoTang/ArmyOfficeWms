...
{
    public class ClouRcsAgvWorkerBusinessHandleViewModel
    {
        public ClouRcsAgvWorkerBusinessHandleProperty DataModel { get; set; }
        public ClouRcsAgvWorkerBusinessHandleViewModel(ClouRcsAgvWorkerBusinessHandleProperty model)
        {
            DataModel = model;
            InitDeviceCodeLst();
