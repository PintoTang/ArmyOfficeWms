...
{
    public class ClSwitchingApplyInWorker : SwtichingWorkerAbstract<SwitchingWorkerBusinessAbstract>
    {
        ...
        protected override Window CreateConfigView()
        {
            ...
            WorkerConfigViewModel<ClSwitchingApplyInWorker, SwitchingWorkerProperty> viewModel = new WorkerConfigViewModel<ClSwitchingApplyInWorker, SwitchingWorkerProperty>(this, WorkerProperty);
