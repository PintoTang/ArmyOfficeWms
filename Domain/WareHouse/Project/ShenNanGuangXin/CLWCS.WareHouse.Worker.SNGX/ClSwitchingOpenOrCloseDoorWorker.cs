...
{
    public class ClSwitchingOpenOrCloseDoorWorker : SwtichingWorkerAbstract<SwitchingWorkerBusinessAbstract>
    {
        ...
        public override OperateResult SwithValueChangeHandle(object sender,int newValue)
        {
            ...
            {
                LogMessage(string.Format("收到就绪：{0}，非1、2 Heart Change不做处理", newValue), EnumLogLevel.Info, true);
        ...
        protected override Window CreateConfigView()
        {
            ...
            WorkerConfigViewModel<ClSwitchingOpenOrCloseDoorWorker, SwitchingWorkerProperty> viewModel = new WorkerConfigViewModel<ClSwitchingOpenOrCloseDoorWorker, SwitchingWorkerProperty>(this, WorkerProperty);
