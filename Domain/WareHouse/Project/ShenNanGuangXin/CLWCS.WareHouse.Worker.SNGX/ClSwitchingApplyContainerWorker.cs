...
{
    public class ClSwitchingApplyContainerWorker : SwtichingWorkerAbstract<SwitchingWorkerBusinessAbstract>
    {
        ...
        protected override Window CreateConfigView()
        {
            ...
            WorkerConfigViewModel<ClSwitchingApplyContainerWorker, SwitchingWorkerProperty> viewModel = new WorkerConfigViewModel<ClSwitchingApplyContainerWorker, SwitchingWorkerProperty>(this, WorkerProperty);
