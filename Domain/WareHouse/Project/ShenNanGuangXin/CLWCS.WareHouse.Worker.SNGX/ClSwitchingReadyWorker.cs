...
{
    public class ClSwitchingReadyWorker : SwtichingWorkerAbstract<SwitchingWorkerBusinessAbstract>
    {
        ...
        public override OperateResult SwithValueChangeHandle(object sender,int newValue)
        {
            if (newValue != -1000)
            {
                LogMessage(string.Format("收到就绪：{0}，非-1000不做处理", newValue), EnumLogLevel.Info, true);
        ...
        protected override Window CreateConfigView()
        {
            ...
            WorkerConfigViewModel<ClSwitchingReadyWorker, SwitchingWorkerProperty> viewModel = new WorkerConfigViewModel<ClSwitchingReadyWorker, SwitchingWorkerProperty>(this, WorkerProperty);
