...
{
    public class ClSwitchingButtonsWorker : SwtichingWorkerAbstract<SwitchingWorkerBusinessAbstract>
    {
        ...
        protected override Window CreateConfigView()
        {
            ...
            WorkerConfigViewModel<ClSwitchingButtonsWorker, SwitchingWorkerProperty> viewModel = new WorkerConfigViewModel<ClSwitchingButtonsWorker, SwitchingWorkerProperty>(this, WorkerProperty);
