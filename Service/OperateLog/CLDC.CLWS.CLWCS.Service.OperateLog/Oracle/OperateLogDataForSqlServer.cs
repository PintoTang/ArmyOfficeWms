...
namespace CLDC.CLWS.CLWCS.Service.OperateLog.Oracle
{
    public sealed class OperateLogDataForOracle:OperateLogDataAbstract
    {
        public OperateLogDataForOracle(IDbHelper dbHelper)
            : base(dbHelper)
        {
        }
