...
namespace CLDC.CLWS.CLWCS.Service.OperateLog.SqlServer
{
    public sealed class OperateLogDataForSqlServer:OperateLogDataAbstract
    {
        public OperateLogDataForSqlServer(IDbHelper dbHelper) : base(dbHelper)
        {
        }
