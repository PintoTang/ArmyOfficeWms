...
namespace CL.WCS.WPF.View.Device
{
    /// <summary>
    ...
    public partial class DeviceShowView : IMainUseCtrl
    {
        ...
        {
            var ucObj = WppnlDevice.Children.GetEnumerator();
            ...
            while (ucObj.MoveNext())
            {
                ...
                object o = tp.GetField("tabCNodeInfo", System.Reflection.BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public | BindingFlags.IgnoreCase).GetValue(nvcItem);
